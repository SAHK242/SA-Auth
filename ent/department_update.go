...
func (du *DepartmentUpdate) AddEmployeeIDs(ids ...uuid.UUID) *DepartmentUpdate {
...
func (du *DepartmentUpdate) RemoveEmployeeIDs(ids ...uuid.UUID) *DepartmentUpdate {
...
// AddEmployeeIDs adds the "employees" edge to the Employee entity by IDs.
func (duo *DepartmentUpdateOne) AddEmployeeIDs(ids ...uuid.UUID) *DepartmentUpdateOne {
...
// RemoveEmployeeIDs removes the "employees" edge to Employee entities by IDs.
func (duo *DepartmentUpdateOne) RemoveEmployeeIDs(ids ...uuid.UUID) *DepartmentUpdateOne {
